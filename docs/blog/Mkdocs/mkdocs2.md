...
??? note "点击展开"
    ```yaml
    #[Info]
    site_name: test中文主题 #your site name 显示在左上角
    site_url: http://wcowin.work/test
    ...
    repo_url: https://github.com/Wcowin/test # 右上角点击跳转的链接
    repo_name: test # 右上角的名字
